        ...
        <div className="review__comment-wrapper d-flex flex-column">
            ...
            <div className="review__client-wrapper order-1 order-md-4 mb-3 mb-md-0">
                <svg width="54" height="53" viewBox="0 0 54 53" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <ellipse cx="27" cy="26.5" rx="27" ry="26.5" fill="#D9D9D9" />
                    <ellipse cx="27" cy="26.5" rx="27" ry="26.5" fill="url(#pattern0_80_1585)" />
                    <defs>
                        <pattern id="pattern0_80_1585" patternContentUnits="objectBoundingBox" width="1" height="1">
                            <use xlinkHref="#image0_80_1585" transform="matrix(0.003125 0 0 0.00318396 0 -0.264151)" />
                        </pattern>
                    </defs>
                </svg>
