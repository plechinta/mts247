...
function OurService({ title }) {
    ...
    console.log("Текущий индекс:", activateIndex);
    ...
    const serviceItems = [
        ...
        { title: 'Help with a flat battery', description: `If your car won't start, we'll come and jump-start it or replace the battery with a new one. We'll get you back on the road in no time.` },
    ...
    console.log(firstServices)
    // setServices(firstServices);
    // for (let i = 0; i < services.length; i++) { 
    //     for (let q = 0; q < services[i].length; q++) {
    //         console.log(services[i][q])
    //     }
    // }
    return (
        <div className="services-wrapper">
            <div className="custom__container">
                ...
                <p className="our-service__text gs-text mb-4">
                    ...
                    Save time and <br></br> get back on the road without visiting a garage.
                </p>
                <div className="row">
                        ...
                        <div className="our-service-b1">
                            ...
                            <div className="our-srvice__txt">
                                ...
                                <p className="our-service__desc gs-text">
                                    ...
                                    quickly and conveniently.<br /><br /> No visits to the service center!
                                </p>
                            </div>
                    ...
                    <div className="col-12 col-xxl-8">
                        ...
                        >
                            ...
                            {firstServices.map(items => (
                                <SplideSlide>
                                    <div className="our-service-slide">
                                        {items.map(item => (
                                            <OurServiceItem title={item.title} description={item.description} />
                                        ))}
                                    </div>
                                </SplideSlide>
                            ))}
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 mt-4 ">
                            ...
                            <div className="service__pagination-block">
                                ...
                                <a className="service__pagination-lg" href="#" onClick={(e) => {
                                    e.preventDefault();
                                ...
                                {firstServices.map((_, index) => (
                                    <a
                                        key={index}
                                        // Важно: добавьте пробел перед is-active, иначе получится класс "service__pagination-smis-active"
                                        className={`service__pagination-sm ${activateIndex === index ? 'is-active' : ''}`}
                                        href="#"
                                        onClick={(e) => {
                                            e.preventDefault();
                                            // splideRef.current.go принимает индекс страницы (0, 1, 2...)
                                ...
                                {/* <a className={`service__pagination-sm ${activateIndex === 1 ? 'is-active' : ''}`} href="#" onClick={(e) => {
                                    e.preventDefault();
