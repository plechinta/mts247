                ...
                <div className="row d-flex flex-column g-4 flex-xxl-row">
                            <div className="col-12 col-xxl-5">
                                <div className="block-nd-title__wrap">
                                    <span className="wrapper__txt gs-text__h3">Need our </span> 
                                    <span className="wrapper__txt gs-text__h3">Service Now ?</span>
                                </div>
                            </div>
                                ...
                                <div className="col-12 col-xxl-5">
                                    <div className="block__number">
                                        ...
                                        <div className="block__ni">
                                            <div className="num_text">Telephone number</div>
                                            <div className="gs-text__h3">+32474036272</div>
                                        </div>
                                    </div>
                                </div>
                        <div className="col-12 col-xxl-2 d-flex justify-content-center">
                            <a href="tel:+32479080218"><button className="gs-btn__b gs-btn">CALL US</button></a>
                            {/* <div className="wrapper__bt">
                                <button className="gs-btn__b gs-btn">CALL US</button>
                            </div> */}
                        </div>
                </div>
            </div>
